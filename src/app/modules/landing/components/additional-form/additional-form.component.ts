...
import { HEAR_ABOUT_OPTIONS, PREFERRED_LANGUAGE_OPTIONS } from '../../../../_core/constants/form.const';
...
export class AdditionalFormComponent extends BaseFormComponent implements OnInit {
  ...
  public readonly PreferredLanguageOptions = PREFERRED_LANGUAGE_OPTIONS;
